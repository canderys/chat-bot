...
public class Bot extends TelegramLongPollingBot {
		...
		if (!usersInSelectingModes.contains(id))
			...
			switch (request.getRequestType())
			{
				...
				case SELECTERROR:
					...
					break;
				default:
					sendTextMessage(id, "Неизвестная команда.\nВы находитесь в режиме выбора героев. Пожалуйста, выберите героев или закончите выбор, нажав <b>результат</b>");
					break;
			}
	}
	...
	private void sendAdvice(long id)
	{
		...
		sendTextMessage(id, "Вы вошли в режив выбора героев.Выберите сторону и добавляйте героев для каждой стороны.");
	}
